...
namespace Daemon
{
	...
	void OpenGLImGuiLayer::OnAttach()
	{
		...
		io.FontDefault = io.Fonts->AddFontFromFileTTF("Assets/Fonts/consola.ttf", 18.0f);
		...
		OpenGLContext context = OpenGLContext::Get();
		ImGui_ImplGlfw_InitForOpenGL(context.GetWindowHandle(), true);
		//ImGui_ImplGlfw_InitForOpenGL((GLFWwindow*)window->GetNativeWindowHandle(), true);
	...
	void OpenGLImGuiLayer::End()
	{
		...
		if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
		{
			// TODO: Fix! This is not working for OpenGL
